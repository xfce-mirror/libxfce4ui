...
static void xfce_gtk_menu_item_fill_base (GtkWidget    *item,
 ...
 *
 * internal convenient method to fill a menu item.
 *
 **/
void
 ...
 * @menu_to_append_item : #GtkMenuShell on which the item should be appended, or NULL
 *
 * Convenient method to create a #GtkMenuItem and preconfigure it with the passed parameters.
 *
 ...
 * @menu_to_append_item : #GtkMenuShell on which the item should be appended, or NULL
 *
 * Convenient method to create a #GtkImageMenuItem and preconfigure it with the passed parameters.
 *
 ...
 * @menu_to_append_item : #GtkMenuShell on which the item should be appended, or NULL
 *
 * Convenient method to create a deprecated #GtkImageMenuItem and preconfigure it with the passed parameters.
 ...
 * @menu_to_append_item : #GtkMenuShell on which the item should be appended, or NULL
 *
 * Convenient method to create a #GtkCheckMenuItem and preconfigure it with the passed parameters.
 *
                              ...
                              GtkMenuShell *menu_to_append_item)
{
  ...
  /* 'gtk_check_menu_item_set_active' has to be done before 'g_signal_connect_swapped', to dont trigger the callback */
                                          ...
                                          GtkMenuShell             *menu_to_append_item)
{
  ...
  else if (action_entry->menu_item_type == XFCE_GTK_MENU_ITEM)
    {
                                                 ...
                                                 GtkMenuShell             *menu_to_append_item)
{
  ...
  else if (action_entry->menu_item_type == XFCE_GTK_RADIO_MENU_ITEM)
    {
 ...
 *
 * convenient method do add separators, used to prevent code duplication
 *
 * Since: 4.16
 **/
void
 ...
 *
 * Convenient method to find a specific action_entry from an array of action_entries
 *
 ...
 * @n_action_entries : size of the action_entries array
 *
 * Convenient method to translate the label text and tooltip text of an array of action_entries
 *
 * Since: 4.16
 **/
void
