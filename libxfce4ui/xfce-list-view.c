...
G_DEFINE_FINAL_TYPE_WITH_PRIVATE (XfceListView, xfce_list_view, GTK_TYPE_TREE_VIEW)
 ...
 *
 * Returns: The newly created #GtkTreeViewColumn
 *
 * Since: 4.21
 *
 **/
 ...
 * @list_view : a #XfceListView
 * @column_id : the id of the column
 * @func      : the custom render function
 *
