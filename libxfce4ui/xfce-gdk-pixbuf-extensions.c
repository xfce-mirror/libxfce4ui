...
/**
 * SECTION: xfce-gdk-pixbuf-extensions
 ...
 **/
GdkPixbuf *
xfce_gdk_pixbuf_spotlight (const GdkPixbuf *source)
{
  GdkPixbuf *dst;
  gboolean has_alpha;
  gint dst_row_stride;
...
/**
 * xfce_gdk_pixbuf_new_from_file_at_max_size:
...
err1:
      ...
      g_set_error (error, G_FILE_ERROR, g_file_error_from_errno (sverrno),
                   ...
                   display_name, g_strerror (sverrno));
      g_free (display_name);
...
#define __XFCE_GDK_PIXBUF_EXTENSIONS_C__
