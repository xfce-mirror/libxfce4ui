...
const ShortcutTemplate xfwm4_shortcut_values[] = {
  ...
  { N_ ("Center window on screen"), "center_window_key" },
  ...
  { N_ ("Move window to next monitor"), "move_window_next_monitor_key" },
  { N_ ("Move window to previous monitor"), "move_window_prev_monitor_key" },
